...
@Component({
  ...
  standalone: true,
  imports: [MatIcon, MatMenuModule, MatRippleModule, FormsModule, MatButtonModule],
...
export class NavBar {
  ...
  fazerLogout(): void {
    ...
    if ((window as any).api) {
      ...
      console.warn('Funcionalidade de minimizar só está disponível na versão desktop.');
    }
  }
}
